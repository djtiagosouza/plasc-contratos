...
<head>
    ...
    <link href='<?php echo $url_base; ?>/assets/css?family=Open+Sans:400,300,600,700' rel='stylesheet' type='text/css'>
    ...
    <link href="<?php echo $url_base; ?>/assets/css/nifty.min.css" rel="stylesheet">


    <!--Nifty Premium Icon [ DEMONSTRATION ]-->
    <link href="<?php echo $url_base; ?>/assets/css/demo/nifty-demo-icons.min.css" rel="stylesheet">


    <!--Demo [ DEMONSTRATION ]-->
    <link href="<?php echo $url_base; ?>/assets/css/demo/nifty-demo.min.css" rel="stylesheet">
    ...
    <link href="<?php echo $url_base; ?>/assets/plugins/pace/pace.min.css" rel="stylesheet">
    <script src="<?php echo $url_base; ?>/assets/plugins/pace/pace.min.js"></script>
    ...
    <!--NiftyJS [ RECOMMENDED ]-->
    <script src="<?php echo $url_base; ?>/assets/js/nifty.min.js"></script>
    ...
    <script src="<?php echo $url_base; ?>/assets/js/demo/nifty-demo.min.js"></script>
